...
import { View, ScrollView, StyleSheet, TextInput, Text, FlatList, RefreshControl, TouchableOpacity, Dimensions } from 'react-native';
...
const MyAttendance = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await axios.get("https://chawlacomponents.com/api/v1/attendance/myAttendance");
      console.log(res)
      ...
      if (parsedData.success && parsedData.data) {
        ...
        const mappedData = userData.map(item => {
         ...
         : 'Need Action';
           ...
           return {
             Date: new Date(parsedData.data[0].date).toLocaleDateString('en-GB', {
               year: 'numeric',
               month: '2-digit',
               day: '2-digit',
             }),
